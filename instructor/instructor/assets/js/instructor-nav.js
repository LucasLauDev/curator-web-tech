    ...
    hydrateSessionUi() {
        ...
        fetch('/api/auth/session', { credentials: 'same-origin' })
            ...
            .then((data) => {
                ...
                document.querySelectorAll('nav a[href*="instructor_profile.html"] img, #instructor-avatar').forEach((img) => {
                    img.src = avatarUrl;
                });
            })
            .catch(() => {});
    ...
    render() {
        ...
        if (!hideSidebar) {
            ...
            <aside id="instructor-sidebar" class="fixed top-16 lg:top-20 left-0 bottom-0 w-72 bg-white z-[70] shadow-2xl transition-all duration-300 border-r border-slate-100 flex flex-col sidebar-mini">
                ...
                <div id="instructor-sidebar-footer" class="p-4 pt-0 border-t border-slate-100 sidebar-footer-text">
